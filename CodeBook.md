...
The code to generate the tidydata.txt is is located in the "run_analysis.R"" file of this repository
...
Column 1 specify the subject Identifier
Column 2 specify activity Identifier
Column 3-79 specify activity features
